...
Q1.3.3 Make a tiny cheerleader for yourself! Create a loop which loops over the letters in your name (you can use `strsplit('yournamehere', '')` to easily separate the letters in a string) and for each letter, it prints out "Give me an [letter]!"
