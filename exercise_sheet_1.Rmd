...
Q1.3.3 Make a loop which sums together values from 1 to 100 and in the end, prints out the result. Make sure you got the correct answer by checking your result with sum(). (This is a fairly difficult task if you do not have any programming experience.)

Hint: You should start by defining a variable and setting it to zero outside of the loop, and then change the value of this variable each loop iteration. 

Hint2: If you get stuck, there's no shame in googling to get ideas how to accomplish something you don't know how to do in R! 
