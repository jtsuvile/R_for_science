...
* [You can see the solutions for the exercises below here](./solutions_exercise_3.html) (but do try to solve the tasks with help from the demo code and google before looking at solutions)
...
Q3.1.2 What needs to get done to make your data tidy? For example, do you need to go from long to wide (`spread`) or wide to long (`gather`) or join data from different files (`full_join`)? 
